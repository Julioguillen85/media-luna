...
public class GroqService {
        ...
        public String buildSystemPrompt(Map<String, Object> businessContext) {
                ...
                prompt.append("  - PASO 5: Tu mensaje final DEBE decir ÚNICAMENTE: '¡Excelente! He generado el resumen de tu pedido. Por favor revísalo a continuación. También te invito a calificar mi atención en el botón superior de la ventana. ¡Fue un gusto ayudarte! 🌙'\n");
